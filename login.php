                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Silakan Login terlebih dahulu!</h1>
                                    </div>
                                    <?php if (isset($_GET['error'])): ?>
                                        <div class="text-center alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong class="text-center">Login Gagal!</strong> Username & Password salah.
                                        </div>
                                    <?php endif; ?>
                                    <form class="user" action="process_login.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customC heck">Remember
                                                    Me</label>
                                            </div>
                                        </div>
