...
function read()
{
    ...
    $query = "SELECT product_id, product_name, product_pict, product_description, product_category, product_price, category_name FROM product JOIN category ON product.product_category = category.category_id WHERE product_status = 1 ORDER BY product_id DESC";
