                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form id="formProduct" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="product_pict" name="product_pict">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="product_stock" name="product_stock" readonly>
                                </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            if (!id) {
                                alert("ID product tidak ditemukan");
                                return;
                            }
                            ...
                            fetch("./api/products/update.php?id=" + id)
                                ...
                                .then(result => {
                                    ...
                                    document.getElementById("product_sub_category").value = p.product_sub_category;
                                    ...
                                    const img = document.getElementById("preview");
                                    img.src = "../assets/uploads/" + p.product_pict;
                                    img.style.display = "block";
                                });
